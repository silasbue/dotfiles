...
# CHANGE THEME BASED ON TERMINAL EMULATOR
...
plugins=(aws docker encode64 git npm sudo yarn zsh-autosuggestions zsh-syntax-highlighting colored-man-pages)
...
# temp fix for vscode zsh history path
